  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      <header className="mb-10">
        ...
        <h1 className="mt-6 text-3xl font-semibold">Built for coding agents</h1>
...
autocloud logs`}
      ...
      <section className="mb-10">
        ...
        <p className="mb-3 text-sm leading-relaxed text-ink-dim">
          ...
          ferramentas analyze_project, estimate_cost, create_project, deploy_project, list_projects,
          get_project, get_deployment e get_logs. A autenticação reusa a da CLI.
        </p>
